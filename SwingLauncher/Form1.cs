...
namespace SwingLauncher
{
	public partial class Form1 : Form
	{
		...
		private async void button1_Click_1(object sender, EventArgs e)
		{
			...
			else if(launchButton.Text == "Retry")
			{
				launchButton.Text = "...";
				Init();
			}
		...
		{
			button6.Text = message;
			noConnectionPanel.Visible = true;
			panel3.Location = new Point(panel3.Location.X, noConnectionPanel.Location.Y - panel3.Height);
			launchButton.Location = new Point(launchButton.Location.X, noConnectionPanel.Location.Y - launchButton.Height - 17);
		}

		public void HideMessage()
		{
			noConnectionPanel.Visible = false;
			panel3.Location = new Point(panel3.Location.X, noConnectionPanel.Location.Y - panel3.Height + noConnectionPanel.Height);
			launchButton.Location = new Point(launchButton.Location.X, noConnectionPanel.Location.Y - launchButton.Height - 17 + noConnectionPanel.Height);
		}
		...
		public async Task<bool> CheckForUpdates()
		{
			...
			{
				ShowMessage("Aww shit! You have no connection to the Swing Launcher servers.");
				launchButton.Text = "Retry";
				return true; //To don't launch the game because user is offline
			}
		...
		private void Form1_Load(object sender, EventArgs e)
		{
			...
			button6.Font = new Font(roboto.FontFamily, 9.0f);
		...
		public async void Init()
		{
			...
			if (updateMode)
			{
				launcherUpdatingPanel.Height = this.Height - noConnectionPanel.Height - 40;
